...
import ShowMore from '../ShowMore/ShowMore';
 ...
 const Item: React.FC<ItemProps> = ({ imageUrl,id,quantity, name,description,price, onIncrement,onDecrement , addCart}) => {
   return (
    <div className='flex flex-col w-screen md:w-5/12 m-auto container overflow-y-scroll'>
      ...
      <div className='flex items-center'>
        ...
        <span className="mx-2 text-xl px-3 py-1">{quantity == undefined ? 0 : quantity}</span>
